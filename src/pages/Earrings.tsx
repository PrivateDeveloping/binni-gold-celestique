...
const Earrings = () => {
  const earrings = [
    ...
    { name: "Twisted Hoops", price: "$325", image: earringsTwisted, label: "14K GOLD" },
    { name: "Stud Elegance", price: "$195", image: product1, label: "14K GOLD" },
    { name: "Drop Dangles", price: "$385", image: product3, label: "14K GOLD" },
    { name: "Chandelier Style", price: "$495", image: product2, label: "14K GOLD" },
    { name: "Minimalist Studs", price: "$165", image: product5, label: "14K GOLD" },
    { name: "Huggie Hoops", price: "$245", image: product7, label: "14K GOLD" },
    { name: "Gemstone Drops", price: "$545", image: product8, label: "14K GOLD" },
    { name: "Threader Earrings", price: "$295", image: product4, label: "14K GOLD" },
  ];
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl font-light tracking-wider">
            Frame your face with timeless beauty
          </p>
        </div>
      </section>
